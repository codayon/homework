...
const Service = () => {
  return (
    <Section className={'pt-8 pb-32'}>
      <Container>
        <Flex className={'flex-col justify-center text-center gap-y-6'}>
          <SubHeading Text={'SERVICES'} />
          <Heading Text={'What I Do For My Customer.'} />
          <SubText Text={'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae blandit lectus. Praesent at hendrerit velit, at dictum nisl.'} className={'max-w-[37.5rem] opacity-70 text-gray-below'} />
        </Flex>
